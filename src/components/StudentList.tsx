...
const StudentList = ( {correo_electronico, nombre,apellido, imagen,matricula,id_rol,token}: User) => {
 
    
  return (
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-white-600">
          ...
          <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-gray-100 hover:text-black">
          ...
          <td className="px-6 py-4">
              <img className="w-10 h-10 rounded-full" src={
                  imagen ? imagen : "https://img.freepik.com/foto-gratis/chico-guapo-seguro-posando-contra-pared-blanca_176420-32936.jpg?size=626&ext=jpg&ga=GA1.1.1788614524.1718236800&semt=sph" } alt="Jese image" />
          </td>
          <td className="px-6 py-4">
